...
X = dataset.iloc[:,[6,7,8,10,12,15,16]].values
...
classifier = RandomForestClassifier(n_estimators=10,criterion='entropy',random_state=0,min_samples_split=20,min_samples_leaf=100)
classifier.fit(X, y)
